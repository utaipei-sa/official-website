...
<template>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 text-center mx-auto position-relative">
            ...
            <p
              class="lead text-black px-5 mt-3"
              :style="{ fontWeight: '500', color: '#003D79' }"
            >
              我們是一群熱心的學生組成的組織 ❤️
              <br />
              為學生謀福利、為學生顧權益 💪
  ...
  <div class="card custom-shadow mx-3 mx-md-4 mt-n5">
    ...
    <div class="text">
      ...
      <hr class="my-4" />
      <p class="content">
        學生會是北市大最高層級的學生自治團體，分為兩大部門，分別是行政部門（學生會）與立法部門（學生議會），我們致力於維護學生權益，成為同學面對校內問題或想表達意見時最直接、最可靠的窗口。
...
.custom-shadow {
  padding: 2rem;
  box-shadow: 0 10px 15px rgba(0, 0, 0, 0.2), 0 20px 40px rgba(0, 0, 0, 0.3);
